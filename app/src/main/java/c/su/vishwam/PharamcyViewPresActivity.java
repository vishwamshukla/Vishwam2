...
public class PharamcyViewPresActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchList.setLayoutManager(new LinearLayoutManager(PharamcyViewPresActivity.this));
    ...
    protected void onStart() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Pharmacy").child("incoming");//.child(Prevalent.currentOnlineUser.getPhone());
...
//                         holder.patientDate.setText(model.getDate());
                        holder.patientOthers.setText(model.getPrescription());
...
//                            @Override
//                            public void onClick(View v) {
//                                Intent intent = new Intent(PharamcyViewPresActivity.this, OPDDetailsActivity.class);
