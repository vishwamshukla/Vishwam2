...
public class HistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchList.setLayoutManager(new LinearLayoutManager(HistoryActivity.this));
    ...
    protected void onStart() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Patient History");//.child(Prevalent.currentOnlineUser.getPhone());
