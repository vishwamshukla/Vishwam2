...
public class ReceptionIpdRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reception_ipd_request);

        inputText = (EditText) findViewById(R.id.search_patient_name);
        searchBtn = (Button) findViewById(R.id.search);
        searchList = findViewById(R.id.search_list);
        searchList.setLayoutManager(new LinearLayoutManager(ReceptionIpdRequestActivity.this));
    ...
    protected void onStart() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("ipd requests");//.child(Prevalent.currentOnlineUser.getPhone());
...
//                         holder.patientDate.setText(model.getDate());
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent intent = new Intent(ReceptionIpdRequestActivity.this, IpdRequestDetailActivity.class);
