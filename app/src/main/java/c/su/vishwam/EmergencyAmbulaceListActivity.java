...
import c.su.vishwam.adapters.ChatroomRecyclerAdapter;
import c.su.vishwam.models.Chatroom;
import c.su.vishwam.models.User;
import c.su.vishwam.models.UserLocation;
import c.su.vishwam.services.LocationService;

import static c.su.vishwam.Constants.ERROR_DIALOG_REQUEST;
import static c.su.vishwam.Constants.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static c.su.vishwam.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;


public class EmergencyAmbulaceListActivity extends AppCompatActivity implements
        View.OnClickListener,
        ChatroomRecyclerAdapter.ChatroomRecyclerClickListener
{

    private static final String TAG = "EmergencyAmbulanceListActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emergency_ambulace_list);
...
//        this.startService(serviceIntent);
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O){
                ...
                EmergencyAmbulaceListActivity.this.startForegroundService(serviceIntent);
            }else{
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(EmergencyAmbulaceListActivity.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(EmergencyAmbulaceListActivity.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
...
//        mDb.setFirestoreSettings(settings);
    ...
    private void navChatroomActivity(Chatroom chatroom){
        Intent intent = new Intent(EmergencyAmbulaceListActivity.this, EmergecnyAmbulanceTrackActivity.class);
    ...
    private void newChatroomDialog(){
        ...
        builder.setTitle("Enter Ambulance number");
        ...
        builder.setPositiveButton("CREATE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(!input.getText().toString().equals("")){
                    ...
                    Toast.makeText(EmergencyAmbulaceListActivity.this, "Enter Ambulance number", Toast.LENGTH_SHORT).show();
                }
            }
        });
