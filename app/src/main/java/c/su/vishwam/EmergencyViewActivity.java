...
public class EmergencyViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchList.setLayoutManager(new LinearLayoutManager(EmergencyViewActivity.this));
    ...
    protected void onStart() {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Emergency");//.child(Prevalent.currentOnlineUser.getPhone());
...
//                         holder.patientDate.setText(model.getDate());
                        holder.patientOthers.setText(model.getDetails());
...
//                            @Override
//                            public void onClick(View v) {
//                                Intent intent = new Intent(EmergencyViewActivity.this, OPDDetailsActivity.class);
