...
public class NurseLoginActivity extends AppCompatActivity {
    ...
    private static final String TAG = "NurseLoginActivity";
...
//                }
        ...
        forgotPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NurseLoginActivity.this, DoctorForgotPasswordActivity.class));
            }
        });
...
//                            updateUI(user);
                            startActivity(new Intent(NurseLoginActivity.this, NurseHomeActivity.class));
                        } else {
                            progressBar.setVisibility(View.INVISIBLE);
                            // If sign in fails, display a message to the user.
                            Log.w(TAG, "signInWithCredential:failure", task.getException());
                            Toast.makeText(NurseLoginActivity.this, "Something went wrong...", Toast.LENGTH_SHORT).show();
                            //startActivity(new Intent(NurseLoginActivity.this, ReceptionLoginActivity.class));
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(NurseLoginActivity.this, "Error-" + message, Toast.LENGTH_SHORT).show();
                                //loadingBar.dismiss();
                                progressBar.setVisibility(View.INVISIBLE);
                            }
                        }
