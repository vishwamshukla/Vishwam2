                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            Intent intent = new Intent(OPDDetailsActivity.this, HomeActivity.class);
                            Toast.makeText(OPDDetailsActivity.this, "Details shared.", Toast.LENGTH_SHORT).show();
                            startActivity(intent);
                            deleteData();
                        }
                    }
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()){
                                            ...
                                            Toast.makeText(OPDDetailsActivity.this, "image shared.", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    }
