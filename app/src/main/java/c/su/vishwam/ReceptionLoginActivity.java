...
public class ReceptionLoginActivity extends AppCompatActivity {
    ...
    private static final String TAG = "ReceptionLoginActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
//                if (v==btRegister){
//                    Intent a = new Intent(ReceptionLoginActivity.this, DoctorRegisterActivity.class);
...
//                }
                startActivity(new Intent(ReceptionLoginActivity.this, ReceptionRegiserActivity.class));
            }
        });
        ...
        forgotPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ReceptionLoginActivity.this, DoctorForgotPasswordActivity.class));
            }
        });
...
//                        Toast.makeText(ReceptionLoginActivity.this, "Something went wrong...", Toast.LENGTH_SHORT).show();
//                    }
//                })
...
//                            updateUI(user);
                            startActivity(new Intent(ReceptionLoginActivity.this, ReceptionActivity.class));
                        } else {
                            progressBar.setVisibility(View.INVISIBLE);
                            // If sign in fails, display a message to the user.
                            Log.w(TAG, "signInWithCredential:failure", task.getException());
                            Toast.makeText(ReceptionLoginActivity.this, "Something went wrong...", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(ReceptionLoginActivity.this, ReceptionLoginActivity.class));
            ...
            mAuth.signInWithEmailAndPassword(email, password)
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                SendUserToHomeActivity();
                                Toast.makeText(ReceptionLoginActivity.this, "Logged in", Toast.LENGTH_SHORT).show();
                                //loadingBar.dismiss();
                                progressBar.setVisibility(View.INVISIBLE);
                            } else {
                                String message = task.getException().toString();
                                Toast.makeText(ReceptionLoginActivity.this, "Error-" + message, Toast.LENGTH_SHORT).show();
                                //loadingBar.dismiss();
                                progressBar.setVisibility(View.INVISIBLE);
                            }
                        }
...
//                                loadingBar.dismiss();
//
//                                Intent intent = new Intent(ReceptionLoginActivity.this,HomeActivity.class);
//                                Prevalent.currentOnlineUser = usersData;
//                                startActivity(intent);
//                            }                        }
//                        else {
//                            loadingBar.dismiss();
//                            Toast.makeText(ReceptionLoginActivity.this, "Invalid Password", Toast.LENGTH_SHORT).show();
//                        }
//                    }
//                }
//                else {
//                    Toast.makeText(ReceptionLoginActivity.this, "Account with this "+phone+" number do not exists", Toast.LENGTH_SHORT).show();
//                    loadingBar.dismiss();
//                }
//            }
//
