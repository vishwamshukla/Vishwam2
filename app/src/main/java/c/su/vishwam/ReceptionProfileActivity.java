...
public class ReceptionProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reception_profile);

        storageProfilePrictureRef = FirebaseStorage.getInstance().getReference().child("Reception Profiles");
        mAuth = FirebaseAuth.getInstance();
        currentUserID = mAuth.getCurrentUser().getUid();
        UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Reception").child(currentUserID);
        ...
        profileChangeTextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                CropImage.activity(imageUri)
                        .setAspectRatio(1, 1)
                        .start(ReceptionProfileActivity.this);
            }
        });
    }
    ...
    {
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Users").child("Reception");
        ...
        Toast.makeText(ReceptionProfileActivity.this, "Profile saved", Toast.LENGTH_SHORT).show();
        //finish();
    }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task)
                        {
                            if (task.isSuccessful())
                            {
                                ...
                                startActivity(new Intent(ReceptionProfileActivity.this, ReceptionActivity.class));
                                Toast.makeText(ReceptionProfileActivity.this, "Profile saved", Toast.LENGTH_SHORT).show();
                                finish();
                            }
                            else
                            {
                                //progressDialog.dismiss();
                                progressBar.setVisibility(View.INVISIBLE);
                                Toast.makeText(ReceptionProfileActivity.this, "Error.", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
